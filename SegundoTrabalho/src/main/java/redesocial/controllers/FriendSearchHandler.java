 ...
 * @author pedroreis
 */
@WebServlet(urlPatterns = {"/user/findfriends"})
public class FriendSearchHandler extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ArrayList<String> friends = (new DatabaseDAO()).findFriends(friendname);
